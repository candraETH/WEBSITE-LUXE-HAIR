...
export function RecommendedProductsCarousel({
  ...
  return (
    <section className="rounded-2xl border border-[#ddd2c8] bg-white p-4 sm:p-5">
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#8a6b22]">Recommended Product</p>
      <h2 className="mt-2 text-3xl font-semibold tracking-tight text-[#141418] sm:text-4xl">{title}</h2>
